...
export function LoginForm({
  ...
  const handleEmailSubmit = (e) => {
    e.preventDefault();
    // Email/password login not implemented - GitHub OAuth is primary method
    alert("Please use GitHub login. Email/password authentication is not configured.");
  };
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        {/* Optional: Toggle for email login */}
        {showEmailLogin && (
          <>
            ...
            <form onSubmit={handleEmailSubmit}>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <a href="#" className="ml-auto text-sm underline-offset-4 hover:underline text-gray-400">
