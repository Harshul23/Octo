...
const FilterPanel = ({ filters, onFilterChange }) => {
  ...
  const languages = ['all', 'JavaScript', 'TypeScript', 'Python', 'CSS', 'Go', 'Rust'];
  ...
  return (
    <div className="p-4 rounded-2xl bg-[#161616] border border-white/5">
      ...
      {/* Difficulty Filter */}
      <div className="mb-4">
        <label className="text-xs text-neutral-500 mb-2 block">Difficulty</label>
      ...
      <div className="space-y-3">
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            ...
            onChange={(e) => onFilterChange({ ...filters, noPRYet: e.target.checked })}
        ...
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            ...
            onChange={(e) => onFilterChange({ ...filters, hasNoComments: e.target.checked })}
            className="w-4 h-4 rounded border-white/20 bg-white/5 text-blue-500 focus:ring-blue-500 focus:ring-offset-0"
          />
