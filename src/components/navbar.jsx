...
function Navbar() {
  ...
  return (
    <div className="bg-[#0a0a0a] w-full h-18 text-white flex justify-between items-center px-4 py-4 box-border ">
        <div className="flex gap-6 items-center">
            <div className="logo h-12 w-12 rounded-full bg-white"><img src={Octo} alt="logo" /></div>
            <h1 className="text-4xl font-bold">Octo</h1>
        </div>
        <div className="">
            <input type="text" className="bg-[#262626] border-2 border-[#707070] rounded-3xl h-11 w-[34em] px-6 py-3" placeholder="Ask Octo"/>
        </div>
        <div className='flex justify-around items-center'>
            <div className="relative right-[17em] flex items-center gap-1 bg-neutral-700 px-2 text-xm py-1 rounded-lg"><Command className='size-3' /> <h1 className='text-xs'>K</h1></div>
        </div>
